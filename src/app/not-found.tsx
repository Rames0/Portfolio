  ...
  return (
    <div className="min-h-screen bg-[#121310] text-[#F4F3EE] flex flex-col items-center justify-center p-6 relative overflow-hidden font-mono site-shell">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(#2C2E29 1px, transparent 1px), linear-gradient(90deg, #2C2E29 1px, transparent 1px)",
      ...
      <div className="relative z-10 max-w-xl w-full border-2 border-[#E3C849] bg-[#161714] p-8 shadow-[8px_8px_0px_#10110E]">
        ...
        <div className="space-y-4 text-xs md:text-sm text-[#A6A89F] leading-relaxed">
          <p>
            <span className="text-[#38BDF8] font-bold">ERROR:</span> The
            requested resource payload could not be located in the current
            origin network.
          </p>
          <p>
            The node you are attempting to address has either been deprecated,
            moved, or never existed in the routing table.
          </p>
        </div>

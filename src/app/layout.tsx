...
export const metadata: Metadata = {
  ...
  description:
    "Ramesh Maharjan is a Full-Stack Engineer and Creative Technologist in Kathmandu, Nepal. Specializing in high-performance React, Next.js, Node.js, Laravel, and WebGL architectures.",
  keywords: [
    "Ramesh Maharjan",
    ...
    "Nepal Incubation & Research Center",
  ...
  openGraph: {
    ...
    description:
      "Explore the technical portfolio of Ramesh Maharjan. Showcasing resilient systems, Next.js / React ecosystems, backend API design in Laravel/Java, and tactile web experiments.",
  },
  twitter: {
    ...
    description:
      "Explore my interactive developer portfolio covering resilient backends (Laravel/Django) and tactile web frontends (Next.js/React).",
  },
  alternates: {
    ...
    <html lang="en" suppressHydrationWarning data-theme="dark" className="dark">
      <head>
        ...
        <script
          id="theme-init"
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var s=localStorage.getItem("ramesh_portfolio_theme");var d=window.matchMedia("(prefers-color-scheme: light)").matches?"light":"dark";var t=s||d;document.documentElement.setAttribute("data-theme",t);if(t==="dark"){document.documentElement.classList.add("dark");document.documentElement.classList.remove("light");}else{document.documentElement.classList.add("light");document.documentElement.classList.remove("dark");}}catch(e){}})()`,
          }}
        />
              ...
              "@graph": [
                {
                  ...
                  description:
                    "Portfolio of Ramesh Maharjan, a full-stack developer in Kathmandu specializing in Next.js, React, Laravel, and enterprise architecture.",
                ...
                },
                {
                  ...
                  description:
                    "Full-Stack Engineer based in Kathmandu, Nepal. Specialist in React.js, Next.js frontends, and Laravel, Node.js backend architectures.",
                  sameAs: [
                ...
                },
                {
                  ...
                  operatingSystem: "Web",
                  description:
                    "A hardware-safe web utility utilizing Web Audio API algorithms, Butterworth filters, and Helmholtz resonance to eject water and particulate debris from mobile speakers.",
                },
                {
                  "@type": "CreativeWork",
                  ...
                  creator: { "@id": "https://ramesh0.com.np/#person" },
                  abstract:
                    "Secure, highly-available centralized portal consolidating 50+ government services for citizens with strict WCAG compliance and RBAC access, built on Java and Grails.",

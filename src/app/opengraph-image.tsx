    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          backgroundImage:
            "linear-gradient(#2C2E29 2px, transparent 2px), linear-gradient(90deg, #2C2E29 2px, transparent 2px)",
      ...
      >
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span style={{ color: "#E3C849", fontSize: 24, fontWeight: "bold" }}>
            Kathmandu, Nepal
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span style={{ color: "#E3C849", fontSize: 24, fontWeight: "bold" }}>
            Resilient Backend & Tactical UIs
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span
            style={{
              color: WORK_STATUS.colorHex,
              fontSize: 24,
              fontWeight: "bold",
            }}
          >
            {WORK_STATUS.available ? "Available" : "Engaged"}
          </span>
        </div>
      </div>
    </div>,

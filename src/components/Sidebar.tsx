  ...
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-xl border border-emerald-400/30 rounded-3xl p-6 flex flex-col shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] relative z-10">
        ...
        >
          <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden bg-gradient-to-br from-emerald-500/20 to-blue-500/20 border border-emerald-500/30 shadow-[0_4px_16px_0_rgba(16,185,129,0.2)]">
            <img 
              src="/Profile.jpeg" 
              alt="Ramesh Profile" 
        ...
        <Button onClick={handleHireMe} className="w-full bg-emerald-400 hover:bg-emerald-500 text-black font-semibold rounded-full py-6 shadow-[0_4px_16px_0_rgba(16,185,129,0.4)] hover:shadow-[0_8px_24px_0_rgba(16,185,129,0.5)] transition-all hover:-translate-y-0.5 active:scale-95">
